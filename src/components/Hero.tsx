    ...
    >
      ...
      <div className="container mx-auto px-6 text-center z-10">
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-foreground mb-6 animate-slide-up tracking-tight">
          Hi, I'm <span className="bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(168,85,247,0.6)] animate-pulse">Aarav Gupta</span>
        </h1>
        <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-slide-up animate-delay-200 leading-relaxed">
          Freshman at Rice University with proven success in Robotics, Computer Vision, Machine Learning, and Algorithmic Design
        </p>
